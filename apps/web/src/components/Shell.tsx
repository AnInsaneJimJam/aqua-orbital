...
export default function Shell({children}:{children:React.ReactNode}){
 ...
 <main id="main">{children}</main><footer className={styles.footer}><div><Link href="/proof">Build evidence</Link><a href="https://www.paradigm.xyz/writing/orbital" target="_blank" rel="noreferrer">Read the paper ↗</a><span>Arc Testnet</span></div><p>{copy.disclosure}</p><small>{copy.attribution}</small></footer></>;
}
