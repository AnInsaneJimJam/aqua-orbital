...
- Name: swap-controls.spec.ts >> saved slippage and deadline alter the actual review and reset explicitly
- Location: test\swap-controls.spec.ts:8:1
...
Locator: getByText('19.7 oUSD18', { exact: true })
Expected: visible
Timeout: 30000ms
Error: element(s) not found

Call log:
  - Expect "toBeVisible" getByText('19.7 oUSD18', { exact: true }) with timeout 30000ms
  - waiting for getByText('19.7 oUSD18', { exact: true })
...
- main:
  ...
  - group:
    ...
    - group "Slippage tolerance":
      ...
      - textbox "Custom slippage (basis points)": "150"
      - paragraph: 1–500 whole basis points. 100 basis points equals 1%.
      - status: "High slippage: you may receive substantially less than the quoted amount."
  ...
  - separator
  - text: Slippage tolerance 1.5% Network fee USDC · estimated at review
