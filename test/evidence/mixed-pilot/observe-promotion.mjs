...
const sources=['test/evidence/mixed-pilot/observe-promotion.mjs','test/evidence/mixed-pilot/validate.mjs',
...
if(process.argv.length!==2)throw Error('USAGE: node test/evidence/mixed-pilot/observe-promotion.mjs');
...
try{
 ...
 report.completedAt=new Date().toISOString();await writeFile(resolve(here,'promotion.json'),json(report));
