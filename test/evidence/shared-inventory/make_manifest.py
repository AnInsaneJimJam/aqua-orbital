...
def main():
    ...
    manifest={
        'schema_version':1,'claim_id':'FROZEN-SHARED-INVENTORY-64-SEQUENCES',
        ...
        'command':'python test/evidence/shared-inventory/run.py fuzz',
