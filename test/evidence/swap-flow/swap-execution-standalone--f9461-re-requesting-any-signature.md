...
- Name: swap-execution.spec.ts >> standalone swap rejects insufficient native inventory before requesting any signature
- Location: test\swap-execution.spec.ts:81:1
...
Locator: getByText(/Insufficient balance for gas/)
Expected: visible
Error: element(s) not found

Call log:
  - Expect "toBeVisible" getByText(/Insufficient balance for gas/) with timeout 30000ms
  - waiting for getByText(/Insufficient balance for gas/)
  - Test ended.
