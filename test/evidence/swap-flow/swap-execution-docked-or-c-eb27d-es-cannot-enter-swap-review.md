...
- Name: swap-execution.spec.ts >> docked or changed-version strategies cannot enter swap review
- Location: test\swap-execution.spec.ts:82:1
...
Locator: getByText(/strategy is docked/)
Expected: visible
Error: element(s) not found

Call log:
  - Expect "toBeVisible" getByText(/strategy is docked/) with timeout 30000ms
  - waiting for getByText(/strategy is docked/)
  - Test ended.
