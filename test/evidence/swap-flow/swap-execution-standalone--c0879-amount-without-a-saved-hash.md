...
- Name: swap-execution.spec.ts >> standalone signature rejection returns an editable amount without a saved hash
- Location: test\swap-execution.spec.ts:83:1
...
Call log:
  - waiting for getByRole('button', { name: 'Submit reviewed swap' })
...
- generic [active] [ref=e1]:
  - link "Skip to content" [ref=e2] [cursor=pointer]:
    - /url: "#main"
  - banner [ref=e3]:
    - link "Orbital home" [ref=e4] [cursor=pointer]:
      - /url: /
      - text: Orbital
    - navigation "Main navigation" [ref=e7]:
      - link "Swap" [ref=e8] [cursor=pointer]:
        - /url: /swap
      - link "Liquidity" [ref=e9] [cursor=pointer]:
        - /url: /liquidity
      - link "Payments" [ref=e10] [cursor=pointer]:
        - /url: /pay
    - button "Manage connected wallet" [ref=e11] [cursor=pointer]: 0x0000…0016
  - main [ref=e12]:
    - generic [ref=e14]:
      - generic [ref=e15]:
        - heading "Swap" [level=1] [ref=e16]
        - generic [ref=e17]: Arc Testnet
      - paragraph [ref=e18]: Trade stablecoin liquidity through Orbital.
      - generic [ref=e19]:
        - generic [ref=e20]: You pay
        - generic [ref=e21]:
          - textbox "You pay" [ref=e22]:
            - /placeholder: "0.00"
            - text: "9007199254.740993"
          - combobox "Input token" [ref=e23]:
            - option "USDC" [selected]
            - option "oUSD6"
            - option "oUSD18"
      - button "Reverse pair" [ref=e25] [cursor=pointer]: ↓
      - generic [ref=e26]:
        - generic [ref=e27]: You receive
        - combobox "You receive" [ref=e28]:
          - option "oUSD6"
          - option "oUSD18" [selected]
        - status "Quoted output" [ref=e29]: 20 oUSD18
      - paragraph [ref=e30]: oUSD6 and oUSD18 are demo tokens — no redemption value.
      - separator [ref=e31]
      - generic [ref=e32]:
        - generic [ref=e33]: Slippage tolerance
        - generic [ref=e34]: 0.50%
      - generic [ref=e35]:
        - generic [ref=e36]: Network fee
        - generic [ref=e37]: USDC · estimated at review
      - region "Quote observation" [ref=e38]:
        - generic [ref=e39]:
          - term [ref=e40]: You pay
          - definition [ref=e41]: 9007199254.740993 USDC
          - term [ref=e42]: Minimum received
          - definition [ref=e43]: 19.9 oUSD18
          - term [ref=e44]: Trading fee · included in input
          - definition [ref=e45]: 900719.925475 USDC
          - term [ref=e46]: Recipient
          - definition [ref=e47]: "0x0000000000000000000000000000000000000016"
          - term [ref=e48]: Approval
          - definition [ref=e49]: Not requested
        - paragraph [ref=e50]: Quote observation. Review checks current funds, strategy availability and transaction simulation before any signature.
        - group [ref=e51]:
          - generic "Quote details" [ref=e52] [cursor=pointer]
      - region "Swap execution" [ref=e53]:
        - status [ref=e54]: Checking the current strategy, funds and simulation…
      - button "Review swap" [disabled] [ref=e55]
      - button "Refresh quote" [disabled] [ref=e56]
      - group [ref=e57]:
        - generic "How execution works" [ref=e58] [cursor=pointer]
  - contentinfo [ref=e59]:
    - generic [ref=e60]:
      - link "Build evidence" [ref=e61] [cursor=pointer]:
        - /url: /proof
      - link "Read the paper ↗" [ref=e62] [cursor=pointer]:
        - /url: https://www.paradigm.xyz/writing/orbital
      - generic [ref=e63]: Arc Testnet
    - paragraph [ref=e64]: Testnet application. Demo tokens have no redemption value. Concentrated liquidity can lose value.
