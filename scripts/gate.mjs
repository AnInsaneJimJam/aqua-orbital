...
const reasons={lint:'A dedicated lint configuration is not implemented. Use pnpm typecheck for the available static checks.','test:invariants':'The full invariant release matrix has not passed. A bounded frozen interior campaign is reproducible with python test/evidence/interior-stateful/run.py ci; see test/evidence/interior-stateful.md and docs/audits/RELEASE_GAP_REVIEW.md for its scope and remaining requirements.'};
